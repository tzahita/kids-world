...
export const HEBREW_LETTERS: HebrewLetter[] = [
  ...
  { char: 'א', name: 'Alef', word: 'אָזְנַיִם', translation: 'Ears', emoji: '👂', category: 'גוף' },
  { char: 'א', name: 'Alef', word: 'אֹכֶל', translation: 'Food', emoji: '🍽️', category: 'אוכל' },
  { char: 'ב', name: 'Bet', word: 'בּוּס', translation: 'Bus', emoji: '🚌', category: 'תחבורה' },
  { char: 'ב', name: 'Bet', word: 'בָּרָק', translation: 'Lightning', emoji: '⚡', category: 'טבע' },
  { char: 'ב', name: 'Bet', word: 'בְּרֹז', translation: 'Faucet', emoji: '🚰', category: 'חפץ' },
  { char: 'ג', name: 'Gimel', word: 'גַּג', translation: 'Roof', emoji: '🏠', category: 'בית' },
  { char: 'ג', name: 'Gimel', word: 'גְּבִינָה', translation: 'Cheese', emoji: '🧀', category: 'אוכל' },
  { char: 'ד', name: 'Dalet', word: 'דַּיִג', translation: 'Fishing', emoji: '🎣', category: 'פעילות' },
  { char: 'ד', name: 'Dalet', word: 'דֹּר', translation: 'Generation', emoji: '👨‍👩‍👧‍👦', category: 'אדם' },
  { char: 'ה', name: 'Hey', word: 'הוֹד', translation: 'Glory', emoji: '✨', category: 'רעיון' },
  { char: 'ו', name: 'Vav', word: 'וִיטָמִין', translation: 'Vitamin', emoji: '💊', category: 'בריאות' },
  { char: 'ז', name: 'Zayin', word: 'זָר', translation: 'Strange', emoji: '🤷', category: 'רעיון' },
  { char: 'ח', name: 'Het', word: 'חֻמוּס', translation: 'Hummus', emoji: '🥙', category: 'אוכל' },
  { char: 'ח', name: 'Het', word: 'חָזֶה', translation: 'Chest', emoji: '🫁', category: 'גוף' },
  { char: 'ט', name: 'Tet', word: 'טוּרְקִי', translation: 'Turkey', emoji: '🦃', category: 'חיה' },
  { char: 'י', name: 'Yud', word: 'יוֹגָה', translation: 'Yoga', emoji: '🧘', category: 'פעילות' },
  { char: 'כ', name: 'Kaf', word: 'כֵּן', translation: 'Yes', emoji: '✅', category: 'רעיון' },
  { char: 'כ', name: 'Kaf', word: 'כָּרִית', translation: 'Pillow', emoji: '🛏️', category: 'בית' },
  { char: 'ל', name: 'Lamed', word: 'לַיְלָה', translation: 'Night', emoji: '🌙', category: 'זמן' },
  { char: 'מ', name: 'Mem', word: 'מִטְרִיָּה', translation: 'Umbrella', emoji: '☂️', category: 'חפץ' },
  { char: 'נ', name: 'Nun', word: 'נָהָר', translation: 'River', emoji: '🏞️', category: 'טבע' },
  { char: 'ס', name: 'Samekh', word: 'סֶלֶר', translation: 'Celery', emoji: '🥬', category: 'אוכל' },
  { char: 'ע', name: 'Ayin', word: 'עָנָן', translation: 'Cloud', emoji: '☁️', category: 'טבע' },
  { char: 'פ', name: 'Pey', word: 'פִּינָה', translation: 'Corner', emoji: '📐', category: 'מקום' },
  { char: 'צ', name: 'Tsadik', word: 'צֶמַח', translation: 'Plant', emoji: '🪴', category: 'טבע' },
  { char: 'ק', name: 'Kuf', word: 'קָפֶה', translation: 'Coffee', emoji: '☕', category: 'שתייה' },
  { char: 'ר', name: 'Resh', word: 'רוּחַ', translation: 'Wind', emoji: '💨', category: 'טבע' },
  { char: 'ש', name: 'Shin', word: 'שָׁלוֹם', translation: 'Peace', emoji: '☮️', category: 'רעיון' },
  { char: 'ת', name: 'Tav', word: 'תּוֹר', translation: 'Turtle Dove', emoji: '🐦', category: 'חיה' },
];
