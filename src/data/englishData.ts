...
export const ENGLISH_LETTERS: EnglishLetter[] = [
  ...
  { char: 'A', word: 'Anchor', emoji: '⚓', category: 'Object' },
  { char: 'A', word: 'Angel', emoji: '👼', category: 'Person' },
  { char: 'B', word: 'Book', emoji: '📚', category: 'Object' },
  { char: 'B', word: 'Boat', emoji: '⛵', category: 'Transport' },
  { char: 'B', word: 'Bell', emoji: '🔔', category: 'Object' },
  { char: 'C', word: 'Clock', emoji: '🕐', category: 'Object' },
  { char: 'C', word: 'Cloud', emoji: '☁️', category: 'Nature' },
  { char: 'C', word: 'Cookie', emoji: '🍪', category: 'Food' },
  { char: 'D', word: 'Dragon', emoji: '🐉', category: 'Animal' },
  { char: 'D', word: 'Deer', emoji: '🦌', category: 'Animal' },
  { char: 'E', word: 'Eye', emoji: '👁️', category: 'Body Part' },
  { char: 'E', word: 'Eraser', emoji: '🧽', category: 'Object' },
  { char: 'F', word: 'Flag', emoji: '🏳️', category: 'Object' },
  { char: 'F', word: 'Feather', emoji: '🪶', category: 'Nature' },
  { char: 'G', word: 'Ghost', emoji: '👻', category: 'Character' },
  { char: 'G', word: 'Glove', emoji: '🧤', category: 'Clothing' },
  { char: 'H', word: 'Honey', emoji: '🍯', category: 'Food' },
  { char: 'H', word: 'Hippo', emoji: '🦛', category: 'Animal' },
  { char: 'I', word: 'Iron', emoji: '🛠️', category: 'Tool' },
  { char: 'J', word: 'Jacket', emoji: '🧥', category: 'Clothing' },
  { char: 'K', word: 'Koala', emoji: '🐨', category: 'Animal' },
  { char: 'L', word: 'Lock', emoji: '🔒', category: 'Object' },
  { char: 'L', word: 'Laptop', emoji: '💻', category: 'Technology' },
  { char: 'M', word: 'Melon', emoji: '🍈', category: 'Food' },
  { char: 'M', word: 'Magnet', emoji: '🧲', category: 'Object' },
  { char: 'N', word: 'Ninja', emoji: '🥷', category: 'Person' },
  { char: 'O', word: 'Otter', emoji: '🦦', category: 'Animal' },
  { char: 'P', word: 'Parrot', emoji: '🦜', category: 'Animal' },
  { char: 'P', word: 'Peach', emoji: '🍑', category: 'Food' },
  { char: 'Q', word: 'Quill', emoji: '🪶', category: 'Object' },
  { char: 'R', word: 'Ring', emoji: '💍', category: 'Object' },
  { char: 'R', word: 'Rhino', emoji: '🦏', category: 'Animal' },
  { char: 'S', word: 'Seal', emoji: '🦭', category: 'Animal' },
  { char: 'S', word: 'Sword', emoji: '⚔️', category: 'Object' },
  { char: 'T', word: 'Tent', emoji: '⛺', category: 'Object' },
  { char: 'U', word: 'Ukulele', emoji: '🎸', category: 'Instrument' },
  { char: 'V', word: 'Vest', emoji: '🦺', category: 'Clothing' },
  { char: 'W', word: 'Worm', emoji: '🪱', category: 'Animal' },
  { char: 'W', word: 'Wrench', emoji: '🔧', category: 'Tool' },
  { char: 'Y', word: 'Yacht', emoji: '🛥️', category: 'Transport' },
];
